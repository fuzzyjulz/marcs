...
def create_membership_fee(year, membership_type, membership_fee, insurance_fee, new_member_fee)
  ...
  membership.club_membership_fee = membership_fee == 1 ? 1 : membership_fee/2
  membership.insurance_fee = insurance_fee > 0 ? insurance_fee/2 : 0
  membership.save!
  ...
  membership.club_membership_fee = membership_fee == 1 ? 1 : membership_fee/2 + new_member_fee
  membership.insurance_fee = insurance_fee > 0 ? insurance_fee/2 : 0
  membership.save!
end
...
create_membership_fee(2017, :spectator,  91.00,     0.00,   40)
...
create_membership_fee(2019, :senior,     1.00,    114.00,   40)
create_membership_fee(2019, :pensioner,  1.00,    114.00,   40)
create_membership_fee(2019, :student,    1.00,    114.00,   40)
create_membership_fee(2019, :junior,     1.00,    114.00/2, 40)
create_membership_fee(2019, :spectator,  1.00,    0,        40)
